...
function buildDocumentFormState({
  ...
  return {
    ...
    tax_enabled: doc?.tax_enabled ?? config?.tax_enabled ?? false,
    due_date: doc?.due_date || '',
    tax_pct: doc?.tax_pct ?? config?.tax_rate ?? 18,
    notes: doc?.notes || '',
    ...
    bank_account_type: resolvedBranding.bank_account_type || config?.bank_account_type || '',
