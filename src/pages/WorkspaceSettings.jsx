...
export default function WorkspaceSettings() {
  ...
  const loadMembers = async () => {
    ...
    try {
      ...
      if (ids.length) { const r = await supabase.from('users').select('id,email,full_name,business_name').in('id', ids); if (!r.error) profiles = r.data || []; }
