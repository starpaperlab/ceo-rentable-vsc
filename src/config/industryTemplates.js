...
export const INDUSTRY_TEMPLATES = {
  ...
  crafts: {
    capacityLabel: '¿Cuántas piezas u órdenes aproximadamente produces al mes?',
    materials: ['Materia prima principal','Pinturas','Pegamentos','Hilos','Cintas','Herrajes','Empaques','Etiquetas'],
    equipment: ['Herramientas manuales','Máquina especializada','Computadora'],
    expenses: [...COMMON_EXPENSES],
    subscriptions: ['Canva'],
  },
  fashion: {
    capacityLabel: '¿Cuántas prendas u órdenes aproximadamente vendes al mes?',
    materials: ['Tela','Hilo','Botones','Zippers','Elásticos','Etiquetas','Empaques'],
    equipment: ['Máquina de coser','Plancha','Mesa de corte','Computadora'],
    expenses: [...COMMON_EXPENSES],
    subscriptions: ['Canva','Software de diseño'],
  },
  accessories: {
    capacityLabel: '¿Cuántas piezas u órdenes aproximadamente vendes al mes?',
    materials: ['Cadenas','Broches','Herrajes','Cuentas','Hilos','Adhesivos','Empaques'],
    equipment: ['Alicates','Herramientas especializadas','Computadora'],
    expenses: [...COMMON_EXPENSES],
    subscriptions: ['Canva'],
  },
  cosmetics: {
    capacityLabel: '¿Cuántas unidades u órdenes aproximadamente vendes al mes?',
    materials: ['Producto base','Envases','Tapas','Etiquetas','Ingredientes','Empaques'],
    equipment: ['Balanza','Mezcladora','Selladora','Herramientas'],
    expenses: [...COMMON_EXPENSES],
    subscriptions: ['Canva'],
  },
  food_beverage: {
    capacityLabel: '¿Cuántos pedidos aproximadamente preparas al mes?',
    materials: ['Ingredientes','Bebidas','Envases','Desechables','Etiquetas','Empaques'],
    equipment: ['Estufa','Horno','Nevera / freezer','Licuadora','Utensilios'],
    expenses: [...COMMON_EXPENSES,'Gas'],
  },
  retail: {
    capacityLabel: '¿Cuántas ventas u órdenes aproximadamente realizas al mes?',
    materials: ['Mercancía para reventa','Bolsas','Cajas','Etiquetas','Empaques'],
    equipment: ['Computadora','Impresora','Lector / POS','Estanterías'],
    expenses: [...COMMON_EXPENSES],
    subscriptions: ['Sistema POS / inventario','Canva'],
  },
  makeup: {
    capacityLabel: '¿Cuántas clientas atiendes aproximadamente al mes?',
    materials: ['Bases','Correctores','Polvos','Sombras','Labiales','Pestañas','Desechables','Productos de higiene'],
    equipment: ['Brochas','Iluminación','Silla','Espejo'],
    expenses: [...COMMON_EXPENSES,'Transporte'],
  },
  beauty: {
    capacityLabel: '¿Cuántas clientas atiendes aproximadamente al mes?',
    materials: ['Productos de tratamiento','Desechables','Guantes','Algodón','Productos de higiene'],
    equipment: ['Camilla','Equipos estéticos','Esterilizador','Herramientas'],
    expenses: [...COMMON_EXPENSES],
  },
  photo_video: {
    capacityLabel: '¿Cuántas sesiones o proyectos realizas aproximadamente al mes?',
    materials: ['Impresiones','Álbumes','Memorias / entregables','Empaques'],
    equipment: ['Cámara','Lentes','Iluminación','Trípode','Computadora','Discos de almacenamiento'],
    expenses: ['Internet','Teléfono','Transporte','Alquiler de estudio'],
    subscriptions: ['Adobe','Canva','Almacenamiento en nube','Galería online'],
  },
  marketing: {
    capacityLabel: '¿Cuántos clientes o proyectos gestionas aproximadamente al mes?',
    materials: [],
    equipment: ['Computadora','Teléfono','Cámara'],
    expenses: ['Internet','Teléfono','Transporte'],
    subscriptions: ['Canva','Adobe','ChatGPT','Gestor de redes','Email marketing','CRM'],
  },
  professional_services: {
    capacityLabel: '¿Cuántos clientes o servicios atiendes aproximadamente al mes?',
    materials: ['Impresiones','Papelería'],
    equipment: COMMON_EQUIPMENT,
    expenses: ['Internet','Teléfono','Transporte','Alquiler'],
    subscriptions: ['Microsoft 365','Google Workspace','Videollamadas','CRM'],
  },
  education: {
    capacityLabel: '¿Cuántos alumnos, clases o programas atiendes aproximadamente al mes?',
    materials: ['Impresiones','Material didáctico','Certificados','Papelería'],
    equipment: ['Computadora','Cámara','Micrófono','Proyector'],
    expenses: ['Internet','Teléfono','Transporte'],
    subscriptions: ['Zoom / videollamadas','Canva','Plataforma de cursos','Email marketing'],
  },
  graphic_design: {
